...
export const fr: Translations = {
  ...
  features: {
    ...
    // DB amenidades_codigos (Spanish snake_case)
    piscina: 'Piscine',
    jardin: 'Jardin',
    garaje: 'Garage',
    seguridad: 'Sécurité 24/7',
    gimnasio: 'Salle de Sport',
    terraza: 'Terrasse',
    balcon: 'Balcon',
    aire_acondicionado: 'Climatisation',
    amueblado: 'Meublé',
    vista_al_mar: 'Vue sur Mer',
    vista_montana: 'Vue sur Montagne',
    ascensor: 'Ascenseur',
    parqueo: 'Parking',
    acepta_mascotas: 'Animaux Acceptés',
    cisterna: 'Citerne',
    patio: 'Patio',
    jacuzzi: 'Jacuzzi',
    lobby: 'Hall',
    planta_electrica: 'Groupe Électrogène',
    area_social: 'Espace Social',
    walk_in_closet: 'Dressing',
    cocina_modular: 'Cuisine Modulaire',
    intercom: 'Interphone',
    pozo: 'Puits',
  },
