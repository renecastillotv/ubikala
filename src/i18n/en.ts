...
export const en: Translations = {
  ...
  features: {
    ...
    amueblado: 'Furnished',
    vista_al_mar: 'Ocean View',
    vista_montana: 'Mountain View',
    ascensor: 'Elevator',
    parqueo: 'Parking',
    acepta_mascotas: 'Pet Friendly',
    cisterna: 'Water Tank',
    patio: 'Patio',
    jacuzzi: 'Jacuzzi',
    lobby: 'Lobby',
    planta_electrica: 'Power Generator',
    area_social: 'Social Area',
    walk_in_closet: 'Walk-in Closet',
    cocina_modular: 'Modular Kitchen',
    intercom: 'Intercom',
    pozo: 'Well',
  },
